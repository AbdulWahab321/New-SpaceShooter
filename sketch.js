var missile,shooter,invader,edges,invader1,invader1GR,missile1,missile1Gr,BigInvader,music1,music2,music3,next,rty,Try;
var PLAY=2;
var START=3;
var END=1;
var INST=4
...
function draw(){
  ...
  if(gameState===INST){
    ...
    text("Press space to shoot rocket",300,200);
